...
export const GlareCard = ({
  ...
  className,
  colorScheme="purple",
  bgColor="rgba(230, 245, 250, 0.9)",
}) => {
  const colorSchemes = {
    default: "rgb(255,119,115),rgba(255,237,95,1),rgba(168,255,95,1),rgba(131,255,247,1),rgba(120,148,255,1),rgb(216,117,255),rgb(255,119,115)",
    blue: "rgb(59,130,246),rgba(96,165,250,1),rgba(147,197,253,1),rgba(191,219,254,1),rgba(147,197,253,1),rgb(96,165,250),rgb(59,130,246)",
    lightBlue: "rgb(173,216,230),rgba(176,224,230,1),rgba(175,238,238,1),rgba(224,255,255,1),rgba(175,238,238,1),rgb(176,224,230),rgb(173,216,230)",
    purple: "rgb(168,85,247),rgba(196,181,253,1),rgba(221,214,254,1),rgba(196,181,253,1),rgba(168,85,247,1),rgb(147,51,234),rgb(168,85,247)",
  };
  ...
  const updateStyles = () => {
    if (refElement.current) {
      ...
      refElement.current?.style.setProperty("--bg-color", bgColor);
    }
  };
  return (
    <div
